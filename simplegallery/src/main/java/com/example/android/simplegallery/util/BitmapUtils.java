...
*/
package com.example.android.simplegallery.util;
...
public class BitmapUtils {
	...
	public static Bitmap getFullImage(Context mContext, Uri uri, int reqWidth, int reqHeight) {
		...
		if (type == TYPE_IMAGE) {
			...
			if (srcBmp == null) {
				srcBmp = BitmapFactory.decodeResource(mContext.getResources(), com.example.android.simplegallery.R.drawable.image_broken);
			}
	...
	public static Bitmap decodeSampledFromUri(Context mContext, Uri uri, int reqWidth, int reqHeight) {
		...
		try {
			...
			return BitmapFactory.decodeResource(mContext.getResources(), com.example.android.simplegallery.R.drawable.image_broken);
		} finally {
			try {
				inputStream.close();
...
//			}
	...
	public static Bitmap createVideoThumbnail(Context mContext, Bitmap video, int width, int height) {
		...
		Bitmap mark = ThumbnailUtils.extractThumbnail(BitmapFactory.decodeResource(mContext.getResources(),
						com.example.android.simplegallery.R.drawable.play_no_bg), markSize, markSize);
